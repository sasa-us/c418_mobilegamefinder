...
export default props => {
    return (
        <div className='aboutPageContainer'>
            ...
            <DevItem src={Martin} name='Martin Rizo' title='Javascript Hero' site='http://www.martinrizo.com' github='https://github.com/Martin92571' linkedin='https://www.linkedin.com/in/martin-rizo-3622b296/' email='mailto:zegrizo@gmail.com' />
